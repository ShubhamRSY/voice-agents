...
<img src="project/static/nexus-logo.svg" alt="Nexus" width="72" height="72" />
...
> **Repository layout:** Nexus application source is in [`project/`](project/). Install, test, and deploy commands below assume `cd project` after cloning.
...
- The **Nexus** name/logo/branding are trademarks. See [`TRADEMARKS.md`](project/TRADEMARKS.md).

Docs: [`docs/saas-hosted.md`](project/docs/saas-hosted.md) · [`COMMERCIAL_LICENSE.md`](project/COMMERCIAL_LICENSE.md)
...
| **Nexus Cloud plans** | Free / Starter / Growth / Enterprise — enquire for paid tiers; see [`docs/saas-hosted.md`](project/docs/saas-hosted.md) |
...
| Change | Description |
|--------|-------------|
| **Nexus Cloud (SaaS)** | Plans API, subscription management, [hosted SaaS docs](project/docs/saas-hosted.md) |
...
| **HIPAA readiness** | `HIPAA_MODE` flag + [compliance checklist](project/docs/compliance/hipaa-readiness.md) |
...
| **Load testing** | k6 smoke script with performance budgets — [docs](project/docs/ops-load-testing.md) |
| **HA roadmap** | Multi-region / Postgres HA architecture doc for future scale — [docs](project/docs/ha-multi-region.md) |
...
docker compose -f project/deploy/docker/docker-compose.yml up

# Include automated backups
docker compose -f project/deploy/docker/docker-compose.yml --profile backup up
```

**Free hosting ($0/month):** See [docs/deploy-oracle-duckdns.md](project/docs/deploy-oracle-duckdns.md) for Oracle Cloud + DuckDNS step-by-step.
...
gunicorn src.main:app --config project/deploy/docker/gunicorn.conf.py
...
Full architecture → [docs/overview.md](project/docs/overview.md#architecture).
...
| Milestone | Docs |
|-----------|------|
| M1 — SSO + observability | [OIDC Auth0 setup](project/docs/ops-oidc-auth0.md) · [Monitoring & alerts](project/docs/ops-monitoring.md) |
| M2 — DR + load testing | [DR runbook (RPO/RTO)](project/docs/ops-dr-runbook.md) · [Load testing](project/docs/ops-load-testing.md) |
| M3 — SOC 2 readiness | [SOC 2 checklist](project/docs/soc2-readiness.md) · [Access controls](project/docs/soc2/access-controls.md) · [Key rotation](project/docs/soc2/key-rotation.md) |
| M4 — HA / multi-region | [HA architecture](project/docs/ha-multi-region.md) |
...
Architecture, SaaS, and ops runbooks → [`docs/`](project/docs/) · [`docs/saas-hosted.md`](project/docs/saas-hosted.md)
...
- **Commercial / enterprise terms:** [`COMMERCIAL_LICENSE.md`](project/COMMERCIAL_LICENSE.md)
- **Public licensing page:** [yournexus.duckdns.org/legal/licensing](https://yournexus.duckdns.org/legal/licensing)
- **Trademarks:** [`TRADEMARKS.md`](project/TRADEMARKS.md)
