...
Omnichannel AI agent platform for customer experience teams — Chat, Copilot, Voice, Email, WhatsApp, SMS, Messenger, Instagram. Grounded with RAG, protected by JWT auth + guardrails.
...
[![Tests](https://img.shields.io/badge/tests-61%20passing-brightgreen.svg)](project/tests/)
