...
class Settings(BaseSettings):
    ...
    dynamics_access_token: str = ""
    copper_api_key: str = ""
    copper_user_email: str = ""
    marketo_client_id: str = ""
    marketo_client_secret: str = ""
    marketo_base_url: str = ""
    klaviyo_api_key: str = ""
    guru_api_token: str = ""
    guru_collection_id: str = ""
    document360_api_token: str = ""
    document360_base_url: str = ""
    five9_webhook_url: str = ""
    five9_api_username: str = ""
    five9_api_password: str = ""
    genesys_api_key: str = ""
    genesys_region: str = ""
    nice_api_key: str = ""
    nice_base_url: str = ""
    ...
    tableau_token_secret: str = ""
    tableau_site_id: str = ""
    powerbi_access_token: str = ""
    powerbi_workspace_id: str = ""
    powerbi_dataset_id: str = ""
    creatio_base_url: str = ""
    creatio_username: str = ""
    creatio_password: str = ""
    salesloft_api_key: str = ""
    sharepoint_site_url: str = ""
    sharepoint_access_token: str = ""
    sharepoint_list_name: str = ""
    talkdesk_api_token: str = ""
    talkdesk_base_url: str = ""
    ujet_api_key: str = ""
    ujet_subdomain: str = ""
    eight_by_eight_api_key: str = ""
    eight_by_eight_webhook_url: str = ""
    gusto_access_token: str = ""
    gusto_company_id: str = ""
    epic_fhir_base_url: str = ""
    epic_fhir_access_token: str = ""
